...
3.  In **Connect** tab, under **Sample data** enter the **Source name**
    as +++***TutorialSource+++*** ![](./media/image19.png)
...
5.  In the **Review and create tab, r**eview the event stream details
    and select **Connect**.
...
6.  In **OneLake data hub** pane ,select **TutorialDashboard** and click
    on **Add** button.

> ![](./media/image58.png)

8.  Enter the following information and click on **Create** button
...
10. In **Admin portal** pane, select **Tenant settings**, scroll down to
...
11. You will see a notification stating - **Applying changes.** It will
    take approximately 15 minutes for implemting the tenant settings.
...
1.  In the report editor,
    select **Visualizations** \> **Map** icon. ![](./media/image92.png)
